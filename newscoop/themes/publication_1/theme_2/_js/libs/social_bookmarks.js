 ...
 *
 * http://www.heise.de/extras/_js/libs/socialshareprivacy/
        ...
        var defaults = {
            'services' : {
                'facebook' : {
                    ...
                    'dummy_img'         : '_js/libs/socialshareprivacy/images/dummy_facebook.png',
                ...
                'twitter' : {
                    'status'            : 'on', 
                    'dummy_img'         : '_js/libs/socialshareprivacy/images/dummy_twitter.png',
                ...
                'gplus' : {
                    'status'            : 'on',
                    'dummy_img'         : '_js/libs/socialshareprivacy/images/dummy_gplus.png',
            ...
            'info_link'         : 'http://localhost/tw/article.php',
            'txt_help'          : 'Die auf Nachrichtenwebsites g&auml;ngigen Buttons zum Weiterempfehlen von Artikeln &uuml;bermitteln anonymisiert Daten an Facebook, Twitter und Google in die USA und werden dort m&ouml;glicherweise gespeichert. Die TagesWoche &uuml;berl&auml;sst Ihnen die Entscheidung, ob Sie das wollen und hat die Daten&uuml;bertragung standardm&auml;ssig deaktiviert. Um die Buttons zu n&uuml;tzen, aktivieren Sie sie per Klick.',
            'settings_perma'    : 'Dauerhaft aktivieren:',
            'cookie_path'       : '/',
            'cookie_domain'     : document.location.host,
            'cookie_expires'    : '365',
            'css_path'          : '_js/libs/socialshareprivacy/socialshareprivacy.css'
        };
        ...
        return this.each(function(){
            ...
            if(options.services.facebook.status == 'on'){
                ...
                if(options.services.facebook.app_id != '__FB_APP-ID__'){
                    ...
                    var fb_code = '<iframe src="http://www.facebook.com/plugins/like.php?locale='+options.services.facebook.language+'&amp;app_id='+options.services.facebook.app_id+'&amp;href='+fb_enc_uri+'&amp;send=false&amp;layout=button_count&amp;width=120&amp;show_faces=false&amp;action=recommend&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:145px; height:21px;" allowTransparency="true"></iframe>';
            ...
            if(options.services.twitter.status == 'on'){
                ...
                var twitter_code = '<iframe allowtransparency="true" frameborder="0" scrolling="no" src="http://platform.twitter.com/widgets/tweet_button.html?url='+twitter_enc_uri+'&amp;counturl='+twitter_count_url+'&amp;text='+text+'&amp;count=horizontal" style="width:130px; height:25px;"></iframe>';
...
/*jQuery(document).ready(function($){
	if($('#social_bookmarks')){
		$('#social_bookmarks').socialSharePrivacy({
		    'services' : {
                'facebook' : {
                    'app_id'            : '128266583938194',
                    'dummy_img'         : '/support/lib/jquery/_js/libs/socialshareprivacy/images/dummy_facebook.png',
                    'referrer_track'    : '/from/facebook'
                }, 
                'twitter' : {
                    'dummy_img'         : '/support/lib/jquery/_js/libs/socialshareprivacy/images/dummy_twitter.png',
                    'referrer_track'    : '/from/twitter'
                },
                'gplus' : {
                    'dummy_img'         : '/support/lib/jquery/_js/libs/socialshareprivacy/images/dummy_gplus.png',
