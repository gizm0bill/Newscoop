...
{{ list_articles ignore_issue="true" constraints="type is news print is off" }}                     
                            ...
                            <li>
                                <article>
                                    ...
                                    <p>{{ include file="_tpl/admin_frontpageedit.tpl" }}{{ $gimme->article->teaser|strip_tags|regex_replace:"/\"(.*?)\"/":"&#171;$1&#187;" }}
                          ...
                          <li>
                              <label for="was">Was?</label>
                                <span class="select-box">
                                  <select id="was" name="genre" class="option_styled">
                                    <option value="kino" selected>Alles</option>
                                    ...
                                    <option value="historischer">Historisch</option>
                            ...
                            <li>
                              <label for="wo">Wo?</label>
                                <span class="select-box">
                                  <select id="wo" name="region" class="option_styled">
    ...
    {{ if $lastmovname != $gimme->article->headline }}
        ...
        {{ /if }}
                      <article>
                          ...
                          <h3><a href="{{ uri options="article" }}?region={{ $linkregion }}">{{ $gimme->article->headline }}</a> <small></small></h3>
