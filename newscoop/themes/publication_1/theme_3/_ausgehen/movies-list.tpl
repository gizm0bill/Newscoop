...
{{ include file="_ausgehen/subnav.tpl" }}
        ...
        <div class="content-box clearfix reverse-columns agenda-content movies-list">
        	...
        	<aside>
                ...
                <ul class="categories">
                	<li class="active"><a href="#">Bewertung</a></li>
                	<li><a href="#">Besucherzahlen</a></li>
                ...
                <ul class="categories">
                	...
                	<li><a href="#">Original + Untertitel</a></li>
                </ul>
            ...
            <section>
                ...
                <article class="movie stared">
                    ...
                    <a href="#" class="grey-button trailer-button"><span>Trailer anschauen</span></a>
