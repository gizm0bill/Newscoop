...
{{ local }}    
            <div id="top" class="clearfix">
                ...
                <h1><a href="{{ set_publication identifier="1" }}{{ set_current_issue }}{{ url options="issue" }}">Tages Woche</a></h1><div class="mobile-date" class="desktop-hide right">{{ $smarty.now|camp_date_format:"wday_name"|truncate:2:"" }}, {{ $smarty.now|camp_date_format:"%e.%m.%Y" }}</div>
            </div><!-- / Top -->
