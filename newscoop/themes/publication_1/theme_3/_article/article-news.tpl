            ...
            <div class="content-box article-single clearfix">
                ...
                <section>
                    ...
                    <article class="article-main-front">
                       <div class="flip-button-container desktop-hide"><a class="grey-button article-switch article-view-rear" href="#"><span></span></a></div>
                        <header>
            ...
            <div class="content-box article-single clearfix">
                ...
                <section>
                    ...
                    <article class="article-main-back">
								<div class="flip-button-container desktop-hide"><a href="#" class="grey-button article-switch article-view-front"><span></span></a></div>
                        <header>
