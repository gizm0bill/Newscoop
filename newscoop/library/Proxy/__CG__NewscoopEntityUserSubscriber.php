 ...
 */
class Subscriber extends \Newscoop\Entity\User\Subscriber implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'email', 'username', 'password', 'first_name', 'last_name', 'created', 'updated', 'status', 'is_admin', 'is_public', 'points', 'image', 'subscriber', 'indexed', 'role', 'groups', 'attributes', 'commenters', 'author', 'subscriptions', 'ips');
    }
