...
class Comment extends \Newscoop\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'article_num', 'subject', 'message', 'thread_level', 'thread_order', 'status', 'ip', 'time_created', 'time_updated', 'likes', 'dislikes', 'recommended', 'indexed', 'commenter', 'forum', 'parent', 'thread', 'article', 'language');
    }
