 ...
 */
class Subscription extends \Newscoop\Entity\Subscription implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'toPay', 'type', 'active', 'subscriber', 'publication', 'sections');
    }
