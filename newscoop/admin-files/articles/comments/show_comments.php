...
<fieldset id="set-good-comment-button-prototype" class="plain comments-block" style="display:none">
    <a href="add_from_comment.php?f_comment_id=${id}&f_publication_id=1&f_issue_number=1&f_section_number=85&f_article_language=5&f_article_type=good_comment" class="ui-state-default text-button"><?php putGS('Good comment'); ?></a>
</fieldset>
